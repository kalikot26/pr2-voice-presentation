...
{
    public partial class Presentations : Form
    {
        ...
        private void enable_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            if (t == "Back Please" || t == "Turn Previous")
            {
                this.Hide();
                System.Threading.Thread.Sleep(300);
                enable.RecognizeAsyncStop();
            ...
            if (t == "Enter Full Screen Presentation")
            {
                this.Hide();
                System.Threading.Thread.Sleep(300);
                enable.RecognizeAsyncStop();
            ...
            if (t == "Exit Full Screen Presentation")
            {
                this.Hide();
                System.Threading.Thread.Sleep(300);
                enable.RecognizeAsyncStop();
        ...
        private void Presentations_Load(object sender, EventArgs e)
        {

        }

        private void lblTimerInv_Click(object sender, EventArgs e)
        {
